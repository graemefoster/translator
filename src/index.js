const fetchEventSource = require('@microsoft/fetch-event-source').fetchEventSource
...
translateButton.style = 'position:fixed; top:0px; left:0px; border: 1px solid black; background-color: white; color: black; z-index: 9999; padding: 10px; font-size: 16px; cursor: pointer;';
